...
## Principaux fichiers
- *style.css* : 
  - Rôle : styliser la calculatrice et ses composants (ex. body, boutons).
  - Contenu : règles CSS avec commentaires et docstrings expliquant le rôle des éléments.  

## Dépendances / hypothèses
- Aucune dépendance n'est nécessaire pour les fichiers contenus dans le répertoire.